...
rem	gmt makecpt -Ccyclic -T0/360/5 -Z > %color% -Ww
	gmt makecpt -Ccyclic -T0/360/15    > %color% 
rem	gmt makecpt -Ccyclic -T0/90/5  -Z > %color% -Ww
rem	gmt makecpt -Cyclic -T0/90/5  -Z > %color%
rem	gmt makecpt -Crainbow -T135/225/5  -Z > %color%
rem	gmt makecpt -Cwhite,blue,white -T0,75,105,360 > %color% 
rem	pause	
rem	gmt makecpt -Cwhite,blue,white -T0,70,110,360 > %color% -Ww
...
REM	Crear Imagen a partir de grilla con sombreado
	gmt grdimage -R -J -O -K %CUT% -C%color% -p >> %OUT%
